...
async def demo_croatian_rag():
    ...
    storage_config = StorageConfig(collection_name="croatian_test", db_path="./temp_chroma_db")
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        print(
            f"📋 Query type: {processed_query.query_type} (confidence: {processed_query.confidence:.3f})"
        )
        ...
        results = storage.query_similar(query_embeddings=[query_embedding.tolist()], n_results=3)
