...
from ..generation.ollama_client import OllamaClient, GenerationRequest
...
class CroatianRAGSystem:
    ...
    async def add_documents(
        ...
        for i in range(0, len(document_paths), batch_size):
            ...
            self.logger.info(f"Processing batch {i//batch_size + 1}/{(len(document_paths)-1)//batch_size + 1}")
            ...
            for doc_path in batch:
                try:
                    ...
                    for chunk_idx, chunk in enumerate(chunks):
                        # Generate embedding
                        embedding = await self._embedding_model.generate_embedding_async(chunk.content)
    ...
    async def query(
        ...
        try:
            ...
            self.logger.info(f"✅ Query processed in {total_time:.2f}s (confidence: {response.confidence:.3f})")
            return response
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            health_status["metrics"] = {
                ...
                "total_chunks": await self._vector_storage.get_document_count() if self._vector_storage else 0
            }
    ...
    async def get_system_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "chunks": await self._vector_storage.get_document_count() if self._vector_storage else 0,
