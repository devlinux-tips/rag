...
class CroatianQueryProcessor:
    ...
    def __init__(self, config: QueryProcessingConfig = None):
        ...
        self.croatian_stop_words = {
            ...
            'te', 'ta', 'to', 'ti', 'tu', 'iz', 'ni', 'li', 'ga', 'mu', 'pa',
            'ne', 'si', 'me', 'mi', 'ih', 'im', 'ju', 'jo', 'ja', 'ma', 'ah',
            'oh', 'al', 'el', 'ol', 'ul', 'ej', 'oj', 'aj', 'uj', 'uh'
        }
    ...
    def _generate_filters(self, query: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Geographic filters
        if re.search(r'\b(zagreb|dubrovnik|split|rijeka|osijek|zadar|pula)\b', query, re.IGNORECASE):
