...
from ..vectordb.search import SemanticSearchEngine, SearchMethod, SearchResponse
...
class IntelligentRetriever:
    ...
    def _multi_pass_search(
        ...
        from ..vectordb.search import SearchResponse, SearchMethod
    ...
    def _calculate_retrieval_confidence(
        ...
        total_matches = sum(
            len(doc['retrieval_metadata']['matching_keywords']) 
