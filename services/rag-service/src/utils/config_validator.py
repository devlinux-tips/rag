...
class ConfigValidator:
    ...
    MAIN_CONFIG_SCHEMA: dict[str, type | tuple[Any, ...]] = {
        ...
        "database.postgresql.host": str,
        "database.postgresql.port": int,
        "database.postgresql.database": str,
        "database.postgresql.user": str,
        "database.postgresql.password": str,
        "database.postgresql.connection_timeout": int,
        "database.postgresql.max_connections": int,
        "database.postgresql.pool_min_size": int,
        "database.postgresql.pool_max_size": int,
        "database.surrealdb.url": str,
        "database.surrealdb.namespace": str,
        "database.surrealdb.database": str,
        "database.surrealdb.username": str,
        "database.surrealdb.password": str,
        "database.surrealdb.connection_timeout": int,
        "database.surrealdb.max_connections": int,
