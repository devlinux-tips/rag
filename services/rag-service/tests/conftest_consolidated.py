...
def create_test_providers(logger_name: str | None = None):
    """Create test providers for cleaning."""
    from src.preprocessing.cleaners_providers import ConfigProvider, LoggerProvider, EnvironmentProvider
    return ConfigProvider(), LoggerProvider(logger_name), EnvironmentProvider()
