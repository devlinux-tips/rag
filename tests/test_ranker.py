...
class TestRankingSignals:
    ...
    def test_content_quality_signal(self, ranker):
        ...
        quality_signal = ranker._calculate_content_quality(
            quality_content, 
            {'title': 'Zagreb - detaljni vodič', 'author': 'Stručnjak'}
        )
...
class TestRankingExplanation:
    ...
    def test_ranking_explanation(self, sample_ranked_doc):
        ...
        signal_lines = [line for line in lines if 'semantic_similarity' in line or 'keyword_relevance' in line]
...
class TestFallbackRanking:
    ...
    def test_fallback_ranking_creation(self):
        ...
        original_docs = [
            {'id': 'doc1', 'content': 'content1', 'metadata': {}, 'relevance_score': 0.9},
            {'id': 'doc2', 'content': 'content2', 'metadata': {}, 'relevance_score': 0.7}
        ]
...
class TestCroatianSpecificFeatures:
    ...
    def test_cultural_references_recognition(self, ranker):
        ...
        query = ProcessedQuery(
            original="dubrovnik", processed="dubrovnik",
            query_type=QueryType.GENERAL, keywords=["dubrovnik"],
            expanded_terms=[], filters={"language": "hr"},
...
class TestFactoryFunction:
    ...
    def test_create_result_ranker(self):
        ...
        ranker_custom = create_result_ranker(
            method=RankingMethod.BM25,
            enable_diversity=False
        )
