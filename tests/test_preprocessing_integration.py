...
from preprocessing import extract_document_text, chunk_croatian_document
...
class TestRealWorldScenarios:
    ...
    def test_mixed_content_document(self):
        ...
        content_types = {
            'headers': any('IZVJEŠTAJ' in chunk.content or 'UVOD' in chunk.content for chunk in chunks),
    ...
    def test_academic_croatian_text(self):
        ...
        complex_terms = ['morfosintaktičke', 'dijakronijski', 'paradigme', 'prijedložno-padežnih']
        combined_text = ' '.join(chunk.content for chunk in chunks)
...
class TestDataIntegrityAndConsistency:
    ...
    def test_no_data_loss_with_overlapping_chunks(self):
        ...
        source_text = "Rečenica broj jedan. Rečenica broj dva. Rečenica broj tri. Rečenica broj četiri."
