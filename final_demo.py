...
async def run_complete_demo():
    ...
    storage_config = StorageConfig(collection_name="final_demo", db_path="./temp_chroma_db")
    ...
    test_queries = ["O čemu se radi u dokumentu?", "Koja je glavna tema?"]
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        results = storage.query_similar(query_embeddings=[query_embedding.tolist()], n_results=2)
